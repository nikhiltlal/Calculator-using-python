...
btn_mul = Button(text=" * ", width="10", height="2", bd=0, font=("poppins", 14, "bold"), bg="#0b74a9", padx=2,
                 activebackground="#105e85", activeforeground="#F9F9F9", command=lambda: button_click("*"))
...
# label
label_ = Label(window, text="Developed By Nikhil T Lal", bg="#1d1e22", fg="#d4d4dc", padx=1, font=("poppins", 10))
